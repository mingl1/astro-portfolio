...
a search function. So in the summer of 2023, after getting tired of scrolling through my TikTok favorites, I started
my work on a better TikTok Favorite manager.

# Phases

At first, I only planned to create a website that I can search through all of my own TikTok favorites, I made a working
website in a few days but did a bunch of improvements and learned a lot after being dissatisfied with the state of the project looking back on it a month later, that was phase 1.
